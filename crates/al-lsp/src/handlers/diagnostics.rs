        ...
        let source = r#"codeunit 50100 Dummy
{
    ...
    #[test]
    fn test_no_semantic_diagnostic_for_global_option_with_empty_first_member() {
        let source = r#"codeunit 50100 Dummy
{
    var
    ...
    begin
        ...
        assert!(
            ...
            "did not expect diagnostics for global option with empty first member, got: {diags:?}"
        );
    }
